...
public class CustomerViewControllerWeaver {
	...
	private ACustomerController controller;
	...
	public CustomerViewControllerWeaver(ACustomerController controller, CustomerTHandler customerTHandler,
	...
	public List<Transition> weaveTransitions() {
		...
		for(Transition t : transitions){
			...
			}else if(t.getTransitionId() == 8){ // Módosítás
